...
class Segment {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, 'segment-disabled': this.disabled, 'segment-scrollable': this.scrollable }) }));
    }
