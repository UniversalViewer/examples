...
class Toast {
    ...
    renderButtons(buttons, side) {
        ...
        return (__chunk_1.h("div", { class: buttonGroupsClasses }, buttons.map(b => __chunk_1.h("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b) }, __chunk_1.h("div", { class: "toast-button-inner" }, b.icon &&
            __chunk_1.h("ion-icon", { icon: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-icon" }), b.text), mode === 'md' && __chunk_1.h("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? 'unbounded' : 'bounded' })))));
    }
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { style: {
                zIndex: `${60000 + this.overlayIndex}`,
            }, class: Object.assign({ [mode]: true }, __chunk_5.createColorClasses(this.color), __chunk_5.getClassMap(this.cssClass), { 'toast-translucent': this.translucent }) }, __chunk_1.h("div", { class: wrapperClass }, __chunk_1.h("div", { class: "toast-container" }, this.renderButtons(startButtons, 'start'), __chunk_1.h("div", { class: "toast-content" }, this.header !== undefined &&
