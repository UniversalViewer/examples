...
class SelectOption {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { role: "option", id: this.inputId, class: __chunk_1.getIonMode(this) }));
    }
    get el() { return __chunk_1.getElement(this); }
...
class SelectPopover {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { class: __chunk_1.getIonMode(this) }, __chunk_1.h("ion-list", null, this.header !== undefined && __chunk_1.h("ion-list-header", null, this.header), (this.subHeader !== undefined || this.message !== undefined) &&
