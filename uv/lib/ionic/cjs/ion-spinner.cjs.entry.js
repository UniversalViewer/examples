...
class Spinner {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, [`spinner-${name}`]: true, 'spinner-paused': !!this.paused || __chunk_2.config.getBoolean('_testing') }) }, svgs));
    }
