...
const __chunk_10 = require('./chunk-a8271f7a.js');
...
class App {
    ...
    componentDidLoad() {
        __chunk_7.rIC(() => {
            const isHybrid = __chunk_2.isPlatform(window, 'hybrid');
            if (!__chunk_2.config.getBoolean('_testing')) {
                new Promise(function (resolve) { resolve(require('./tap-click-3c30533d.js')); }).then(module => module.startTapClick(__chunk_2.config));
            }
            if (__chunk_2.config.getBoolean('statusTap', isHybrid)) {
                new Promise(function (resolve) { resolve(require('./status-tap-e647e000.js')); }).then(module => module.startStatusTap());
            }
            ...
            if (__chunk_2.config.getBoolean('hardwareBackButton', isHybrid)) {
...
class Buttons {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { class: __chunk_1.getIonMode(this) }));
    }
...
class Content {
    ...
    render() {
        ...
        const transitionShadow = (mode === 'ios' && __chunk_2.config.getBoolean('experimentalTransitionShadow', false));
        this.resize();
...
class Footer {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { role: "contentinfo", class: {
                [mode]: true,
...
class Header {
    ...
    render() {
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { role: "banner", class: {
                [mode]: true,
                // Used internally for styling
                [`header-${mode}`]: true,
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-bc6d23b4.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
...
class ToolbarTitle {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: Object.assign({ [mode]: true, [`title-${mode}`]: true }, __chunk_5.createColorClasses(this.color)) }, __chunk_1.h("div", { class: "toolbar-title" }, __chunk_1.h("slot", null))));
    }
    get el() { return __chunk_1.getElement(this); }
