...
class ActionSheet {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { role: "dialog", "aria-modal": "true", style: {
                zIndex: `${20000 + this.overlayIndex}`,
            }, class: Object.assign({ [mode]: true }, __chunk_5.getClassMap(this.cssClass), { 'action-sheet-translucent': this.translucent }), onIonActionSheetWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, __chunk_1.h("ion-backdrop", { tappable: this.backdropDismiss }), __chunk_1.h("div", { class: "action-sheet-wrapper", role: "dialog" }, __chunk_1.h("div", { class: "action-sheet-container" }, __chunk_1.h("div", { class: "action-sheet-group" }, this.header !== undefined &&
