...
class Col {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: {
                [mode]: true
            }, style: Object.assign({}, this.calculateOffset(isRTL), this.calculatePull(isRTL), this.calculatePush(isRTL), this.calculateSize()) }, __chunk_1.h("slot", null)));
    }
...
class Row {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { class: __chunk_1.getIonMode(this) }, __chunk_1.h("slot", null)));
    }
