...
const iosTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./ios.transition-4c0b47ec.js')); });
const mdTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./md.transition-5d38aeca.js')); });
...
const animation = async (animationBuilder, opts) => {
    ...
    const trans = await new Promise(function (resolve) { resolve(require('./index-68424d7d.js')); }).then(mod => mod.create(animationBuilder, opts.baseEl, opts));
