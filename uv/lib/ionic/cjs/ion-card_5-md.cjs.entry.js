...
class Card {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: Object.assign({ [mode]: true }, __chunk_5.createColorClasses(this.color), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() }) }, this.renderCard(mode)));
    }
...
class CardHeader {
    ...
    render() {
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { class: Object.assign({}, __chunk_5.createColorClasses(this.color), { 'card-header-translucent': this.translucent, [mode]: true }) }, __chunk_1.h("slot", null)));
    }
...
class CardSubtitle {
    ...
    render() {
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { role: "heading", "aria-level": "3", class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true }) }, __chunk_1.h("slot", null)));
    }
...
class CardTitle {
    ...
    render() {
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { role: "heading", "aria-level": "2", class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true }) }, __chunk_1.h("slot", null)));
    }
