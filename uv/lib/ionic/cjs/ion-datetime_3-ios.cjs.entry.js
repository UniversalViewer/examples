...
class Picker {
    ...
    render() {
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { "aria-modal": "true", class: Object.assign({ [mode]: true,
                // Used internally for styling
                [`picker-${mode}`]: true }, __chunk_5.getClassMap(this.cssClass)), style: {
                zIndex: `${20000 + this.overlayIndex}`
            }, onIonBackdropTap: this.onBackdropTap }, __chunk_1.h("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), __chunk_1.h("div", { class: "picker-wrapper", role: "dialog" }, __chunk_1.h("div", { class: "picker-toolbar" }, this.buttons.map(b => (__chunk_1.h("div", { class: buttonWrapperClass(b) }, __chunk_1.h("button", { type: "button", onClick: () => this.buttonClick(b), class: buttonClass(b) }, b.text))))), __chunk_1.h("div", { class: "picker-columns" }, __chunk_1.h("div", { class: "picker-above-highlight" }), this.presented && this.columns.map(c => __chunk_1.h("ion-picker-column", { col: c })), __chunk_1.h("div", { class: "picker-below-highlight" })))));
    }
    get el() { return __chunk_1.getElement(this); }
...
class PickerColumnCmp {
    ...
    async componentDidLoad() {
        ...
        this.refresh();
        this.gesture = (await new Promise(function (resolve) { resolve(require('./index-e5a21441.js')); })).createGesture({
            el: this.el,
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: {
            ...
            } }, col.prefix && (__chunk_1.h("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)), __chunk_1.h("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: el => this.optsEl = el }, col.options.map((o, index) => __chunk_1.h(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text))), col.suffix && (__chunk_1.h("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))));
    }
    get el() { return __chunk_1.getElement(this); }
    static get watchers() { return {
        "col": ["colChanged"]
