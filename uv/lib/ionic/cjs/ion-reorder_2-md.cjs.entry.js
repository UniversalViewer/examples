...
class Reorder {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { class: __chunk_1.getIonMode(this) }, __chunk_1.h("slot", null, __chunk_1.h("ion-icon", { name: "reorder", lazy: false, class: "reorder-icon" }))));
    }
