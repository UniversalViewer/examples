...
class ItemDivider {
    ...
    render() {
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, 'item-divider-sticky': this.sticky, 'item': true }) }, __chunk_1.h("slot", { name: "start" }), __chunk_1.h("div", { class: "item-divider-inner" }, __chunk_1.h("div", { class: "item-divider-wrapper" }, __chunk_1.h("slot", null)), __chunk_1.h("slot", { name: "end" }))));
    }
    get el() { return __chunk_1.getElement(this); }
...
class ItemGroup {
    ...
    render() {
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { role: "group", class: {
                [mode]: true,
...
class Label {
    ...
    render() {
        const position = this.position;
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, { class: Object.assign({}, __chunk_5.createColorClasses(this.color), { [mode]: true, [`label-${position}`]: position !== undefined, [`label-no-animate`]: (this.noAnimate) }) }));
    }
    get el() { return __chunk_1.getElement(this); }
...
class SkeletonText {
    ...
    render() {
        ...
        const mode = __chunk_1.getIonMode(this);
        return (__chunk_1.h(__chunk_1.Host, Object.assign({ class: {
                [mode]: true,
                'skeleton-text-animated': animated,
                'in-media': inMedia
            } }, this.calculateWidth()), __chunk_1.h("span", null, "\u00A0")));
    }
    get el() { return __chunk_1.getElement(this); }
