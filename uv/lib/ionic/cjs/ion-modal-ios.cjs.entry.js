...
class Modal {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { "no-router": true, "aria-modal": "true", class: Object.assign({ [mode]: true }, __chunk_5.getClassMap(this.cssClass)), style: {
                zIndex: `${20000 + this.overlayIndex}`,
            }, onIonBackdropTap: this.onBackdropTap, onIonDismiss: this.onDismiss, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle }, __chunk_1.h("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), __chunk_1.h("div", { role: "dialog", class: {
                [`modal-wrapper`]: true,
                [mode]: true,
            } })));
    }
