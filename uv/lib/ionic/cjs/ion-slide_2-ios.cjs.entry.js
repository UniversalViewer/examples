...
class Slides {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: {
            ...
            } }, __chunk_1.h("div", { class: "swiper-wrapper" }, __chunk_1.h("slot", null)), this.pager && __chunk_1.h("div", { class: "swiper-pagination", ref: el => this.paginationEl = el }), this.scrollbar && __chunk_1.h("div", { class: "swiper-scrollbar", ref: el => this.scrollbarEl = el })));
    }
