...
class TabBar {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { role: "tablist", "aria-hidden": keyboardVisible ? 'true' : null, class: Object.assign({}, __chunk_5.createColorClasses(color), { [mode]: true, 'tab-bar-translucent': translucent, 'tab-bar-hidden': keyboardVisible }) }, __chunk_1.h("slot", null)));
    }
