...
class Popover {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { "aria-modal": "true", "no-router": true, style: {
                zIndex: `${20000 + this.overlayIndex}`,
            }, class: Object.assign({}, __chunk_5.getClassMap(this.cssClass), { [mode]: true, 'popover-translucent': this.translucent }), onIonPopoverDidPresent: onLifecycle, onIonPopoverWillPresent: onLifecycle, onIonPopoverWillDismiss: onLifecycle, onIonPopoverDidDismiss: onLifecycle, onIonDismiss: this.onDismiss, onIonBackdropTap: this.onBackdropTap }, __chunk_1.h("ion-backdrop", { tappable: this.backdropDismiss, visible: this.showBackdrop }), __chunk_1.h("div", { class: "popover-wrapper" }, __chunk_1.h("div", { class: "popover-arrow" }), __chunk_1.h("div", { class: "popover-content" }))));
    }
