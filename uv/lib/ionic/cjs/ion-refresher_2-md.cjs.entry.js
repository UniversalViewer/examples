...
class Refresher {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { slot: "fixed", class: {
                [mode]: true,
...
class RefresherContent {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { class: __chunk_1.getIonMode(this) }, __chunk_1.h("div", { class: "refresher-pulling" }, this.pullingIcon &&
            __chunk_1.h("div", { class: "refresher-pulling-icon" }, __chunk_1.h("ion-icon", { icon: this.pullingIcon, lazy: false })), this.pullingText &&
            __chunk_1.h("div", { class: "refresher-pulling-text", innerHTML: __chunk_8.sanitizeDOMString(this.pullingText) })), __chunk_1.h("div", { class: "refresher-refreshing" }, this.refreshingSpinner &&
