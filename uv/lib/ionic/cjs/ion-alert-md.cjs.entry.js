...
class Alert {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { role: "dialog", "aria-modal": "true", style: {
            ...
            }, class: Object.assign({}, __chunk_5.getClassMap(this.cssClass), { [mode]: true, 'alert-translucent': this.translucent }), onIonAlertWillDismiss: this.dispatchCancelHandler, onIonBackdropTap: this.onBackdropTap }, __chunk_1.h("ion-backdrop", { tappable: this.backdropDismiss }), __chunk_1.h("div", { class: "alert-wrapper" }, __chunk_1.h("div", { class: "alert-head" }, header && __chunk_1.h("h2", { id: hdrId, class: "alert-title" }, header), subHeader && __chunk_1.h("h2", { id: subHdrId, class: "alert-sub-title" }, subHeader)), __chunk_1.h("div", { id: msgId, class: "alert-message", innerHTML: __chunk_8.sanitizeDOMString(this.message) }), this.renderAlertInputs(labelledById), this.renderAlertButtons())));
    }
