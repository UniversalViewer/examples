...
class ProgressBar {
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { role: "progressbar", "aria-valuenow": type === 'determinate' ? value : null, "aria-valuemin": "0", "aria-valuemax": "1", class: Object.assign({}, __chunk_5.createColorClasses(color), { [mode]: true, [`progress-bar-${type}`]: true, 'progress-paused': paused, 'progress-bar-reversed': document.dir === 'rtl' ? !reversed : reversed }) }, type === 'indeterminate'
            ? renderIndeterminate()
...
const renderProgress = (value, buffer) => {
    const finalValue = __chunk_7.clamp(0, value, 1);
    const finalBuffer = __chunk_7.clamp(0, buffer, 1);
    return [
        __chunk_1.h("div", { class: "progress", style: { transform: `scaleX(${finalValue})` } }),
        finalBuffer !== 1 && __chunk_1.h("div", { class: "buffer-circles" }),
        __chunk_1.h("div", { class: "progress-buffer-bar", style: { transform: `scaleX(${finalBuffer})` } }),
    ];
};
