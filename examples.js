...
$(function(){
    ...
    if (testBuild){
        $("body").append('<script type="text/javascript" id="embedUV" src="/build/uv-0.1.15/js/embed.js"><\/script>');
    } else {
        if (isLocalhost){
    ...
    $('#editBtn').on('click', function(e) {
        ...
        if ($('#editPnl').hasClass('show')){
            ...
            $.getJSON('/build/uv-0.1.15/js/coreplayer-seadragon-extension-config.js', function(baseConfig){
