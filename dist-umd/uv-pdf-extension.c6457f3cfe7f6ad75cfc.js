...
var PDFCenterPanel = /** @class */ (function (_super) {
    ...
    PDFCenterPanel.prototype.openMedia = function (resources) {
        ...
        this.extension.getExternalResources(resources).then(function () { return __awaiter(_this, void 0, void 0, function () {
            var mediaUri, canvas, formats, pdfUri, _a, parameter;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!!_edsilv_utils__WEBPACK_IMPORTED_MODULE_3__["Bools"].getBool(this.extension.data.config.options.usePdfJs, false)) return [3 /*break*/, 2];
                        _a = window;
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, Promise.all(/*! import() | pdfjs */[__webpack_require__.e("vendors~pdfjs"), __webpack_require__.e("pdfjs")]).then(__webpack_require__.t.bind(null, /*! pdfjs-dist */ "./node_modules/pdfjs-dist/build/pdf.js", 7))];
                    case 3:
                        PDFJS = _b.sent();
                        ...
                        PDFJS.getDocument(parameter).then(function (pdfDoc) {
                            ...
                            _this._render(_this._pageIndex);
                            _this.component.publish(_extensions_uv_pdf_extension_Events__WEBPACK_IMPORTED_MODULE_2__["Events"].PDF_LOADED, pdfDoc);
...
//# sourceMappingURL=uv-pdf-extension.c6457f3cfe7f6ad75cfc.js.map