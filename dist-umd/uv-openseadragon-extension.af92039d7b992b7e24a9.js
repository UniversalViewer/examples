...
var OpenSeadragonCenterPanel = /** @class */ (function (_super) {
    ...
    OpenSeadragonCenterPanel.prototype.createNavigationButtons = function () {
        ...
        this.viewer.addControl(this.$prevButton[0], { anchor: openseadragon__WEBPACK_IMPORTED_MODULE_7___default.a.ControlAnchor.TOP_LEFT });
        this.viewer.addControl(this.$nextButton[0], { anchor: openseadragon__WEBPACK_IMPORTED_MODULE_7___default.a.ControlAnchor.TOP_RIGHT });
    ...
    OpenSeadragonCenterPanel.prototype.prevAnnotation = function () {
        ...
        if (foundRect && this.isZoomToSearchResultEnabled()) {
            ...
            if (foundRect.canvasIndex < this.extension.helper.canvasIndex) {
                ...
                this.component.publish(_uv_shared_module_BaseEvents__WEBPACK_IMPORTED_MODULE_3__["BaseEvents"].ANNOTATION_CANVAS_CHANGED, [foundRect]);
            }
            else {
    ...
    OpenSeadragonCenterPanel.prototype.setNavigatorVisible = function () {
        var navigatorEnabled = _edsilv_utils__WEBPACK_IMPORTED_MODULE_0__["Bools"].getBool(this.extension.getSettings().navigatorEnabled, true) && this.extension.isDesktopMetric();
...
//# sourceMappingURL=uv-openseadragon-extension.af92039d7b992b7e24a9.js.map